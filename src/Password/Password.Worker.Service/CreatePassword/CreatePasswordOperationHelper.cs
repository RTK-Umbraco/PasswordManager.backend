...
internal class CreatePasswordOperationHelper
{
    ...
    {
        return GetCreatePassword(operation, OperationDataConstants.PasswordCreateFriendlyName);
    }
    ...
    {
        return GetCreatePassword(operation, OperationDataConstants.PasswordCreatePassword);
    }
}
