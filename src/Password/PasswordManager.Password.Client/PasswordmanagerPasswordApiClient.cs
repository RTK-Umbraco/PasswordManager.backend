...
namespace Umbraco.Cloud.Passwordmanager.Password.Api.Client
{
    ...
    public partial class PasswordmanagerPasswordApiClient : IPasswordmanagerPasswordApiClient
    {
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/generate/password?");
    ...
    public partial record PasswordResponse
    {
        ...
        public PasswordResponse(string @friendlyName, System.Guid @id, string @password, string @url, string @username)
