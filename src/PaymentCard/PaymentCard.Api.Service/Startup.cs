...
using PasswordManager.PaymentCard.ApplicationServices.Extensions;
using PasswordManager.PaymentCard.Infrastructure.Extensions;

namespace PasswordManager.PaymentCard.Api.Service;
