using PasswordManager.PaymentCard.ApplicationServices.Repositories;
...
namespace PasswordManager.PaymentCard.Infrastructure.BaseRepository;
public abstract class BaseRepository<T, TE> : IBaseRepository<T> where T : BaseModel where TE : BaseEntity
{
    ...
    private PaymentCardContext context;
