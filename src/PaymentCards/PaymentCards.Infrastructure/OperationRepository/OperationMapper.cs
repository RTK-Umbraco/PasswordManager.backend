...
internal static class OperationMapper
{
    internal static OperationEntity Map(Operation operation)
    {
        var entity = new OperationEntity(operation.Id, operation.CreatedUtc, operation.ModifiedUtc,
            operation.RequestId, operation.PaymentCardId, operation.CreatedBy, operation.Name, operation.Status,
    ...
    {
        var model = new Operation(operation.Id, operation.RequestId, operation.CreatedBy, operation.PaymentCardId,
